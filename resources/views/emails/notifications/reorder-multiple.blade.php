...
<p>Hello, Admin</p>
<p>Kindly note that the following product(s) has/have reached reorder level or below reorder level.</p>
<p>Kindly restock.</p>
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; width: 100%; max-width: 600px; margin: 0 auto;">
              ...
              <tr>
                <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; margin: 0;" align="left">
                  ...
                  <table class="table table-bordered" border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; width: 100%; max-width: 100%; border: 1px solid #dee2e6;">
                    <thead>
                    <tr>
                      <th style="line-height: 24px; font-size: 16px; margin: 0; padding: 12px; border-color: #dee2e6; border-style: solid; border-width: 1px 1px 2px;" align="left" valign="top">Brand Name</th>
                      <th style="line-height: 24px; font-size: 16px; margin: 0; padding: 12px; border-color: #dee2e6; border-style: solid; border-width: 1px 1px 2px;" align="left" valign="top">Generic Name</th>
                      <th style="line-height: 24px; font-size: 16px; margin: 0; padding: 12px; border-color: #dee2e6; border-style: solid; border-width: 1px 1px 2px;" align="left" valign="top">Quantity</th>
                      <th style="line-height: 24px; font-size: 16px; margin: 0; padding: 12px; border-color: #dee2e6; border-style: solid; border-width: 1px 1px 2px;" align="left" valign="top">Reorder Level</th>
                    </tr>
                    </thead>
                    <tbody>
                    @if ($products->isNotEmpty())
                      @foreach($products as $product)
                        <tr>
                          <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; margin: 0; padding: 12px; border: 1px solid #dee2e6;" align="left" valign="top">{{ $product->brand_name }}</td>
                          <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; margin: 0; padding: 12px; border: 1px solid #dee2e6;" align="left" valign="top">{{ $product->generic_name }}</td>
                          <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; margin: 0; padding: 12px; border: 1px solid #dee2e6;" align="left" valign="top">{{ $product->quantity }}</td>
                          <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; margin: 0; padding: 12px; border: 1px solid #dee2e6;" align="left" valign="top">{{ $product->reorder_level }}</td>
                        </tr>
                      @endforeach
                    @endif
                    </tbody>
